"""
XGBoost Model for Cricket Winning Prediction
"""
...
class XGBoostModel:
    ...
    def set_parameters(self, n_estimators=None, max_depth=None, learning_rate=None):
        ...
        self.is_trained = False  # Need to retrain with new parameters